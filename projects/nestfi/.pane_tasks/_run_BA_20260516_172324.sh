...
claude --print --model 'claude-haiku-4-5' "Execute the routed pane task described in .pane_tasks/BA_20260516_172324.md. Read the file, perform the work, update files as needed, and report completion. Do not use internal subagents (the task tool is disabled in .claude/settings.json and AGENTS.md)."
EXIT_CODE=$?
